...
public class ButtonRandom : BaseButton
{
  ...
  {
    value = state.activeDataGame.hints.GetValueOrDefault(TypeEntity.RandomLetter);
  ...
  public async override void RunHint()
  {
    ...
    var newEntity = await _levelManager.AddEntity(node.arrKey, TypeEntity.RandomLetter, false);
