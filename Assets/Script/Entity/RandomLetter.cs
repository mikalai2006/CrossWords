...
public class RandomLetter : BaseEntity
{
  #region Unity methods
  protected override void Awake()
  {
    configEntity = _gameManager.ResourceSystem.GetAllEntity().Find(t => t.typeEntity == TypeEntity.RandomLetter);
  ...
  public override void Collect()
  {
    ...
    Vector3 positionTo = _levelManager.ManagerHiddenWords.tilemap.WorldToCell(_levelManager.buttonStar.transform.position) + new Vector3(.75f, .75f);
    RunMoveEffect();
    ...
    transform
      ...
      .OnComplete(() =>
      {
        _stateManager.UseHint(1, TypeEntity.RandomLetter);
